...
- **Mini Jukebox** (25% scale) — plays the tracks you've unlocked from Jukebox
  Disks, using the game's own jukebox engine + in-world controls.
- **Mini Speaker** (50% scale) — clear audio inside the cramped cab.
...
## 🙏 Credits
Based on [Build In Seatruck](https://www.nexusmods.com/subnauticabelowzero/mods/287)
